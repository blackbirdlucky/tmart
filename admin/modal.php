...
<!--        		<input type="text" class="form-control" name="edit_username" value="--><?//=$value['usernamer'] ?><!--" placeholder="Логин">-->
<!--        	</div>-->
<!--        	<div class="form-group">-->
<!--        		<input type="text" class="form-control" name="edit_is_admin" value="--><?//=$value['is_admin'] ?><!--" placeholder="Уровень доступа">-->
<!--        	</div>-->
        ...
        <div class="modal-content shadow">
            ...
            <div class="modal-body">
                <form action="" method="post">
                    <div class="form-group">
                        <input type="text" class="form-control" name="username" value="" placeholder="Login">
                    </div>
                    <div class="form-group">
                        <input type="text" class="form-control" name="password" value="" placeholder="Password">
                    </div>
                    <div class="form-group">
                        <input type="text" class="form-control" name="is_admin" value="" placeholder="Access">
                    </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Отмена</button>
